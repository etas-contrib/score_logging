...
using ::score::mw::log::detail::DatarouterMessageClientMock;
using ::testing::_;
...
TEST_F(DatarouterMessageClientMockTest, ShutdownIsInvoked)
{
    DatarouterMessageClientMock mock_client;

    EXPECT_CALL(mock_client, Shutdown()).Times(1);
